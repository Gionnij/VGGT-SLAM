...
@dataclass
class DatamoduleArgsConfigCityscapes(NestedConfig):
    crop_size: List[int] = field(default_factory=lambda: [1024, 512])
    base_size: List[int] = field(default_factory=lambda: [1024, 512])
    base_size_val: List[int] = field(default_factory=lambda: [2048, 1024])
    scale_range: List[int] = field(default_factory=lambda: [1.0, 2.0])
...
class DatamoduleConfig(NestedConfig):
    name: str = "cityscapes"
    args: DatamoduleArgsConfigCityscapes = field(
        default_factory=lambda: DatamoduleArgsConfigCityscapes()
    )
...
class ModuleConfig(NestedConfig):
    ...
    debug: bool = False
    small_validation_size: int = 200
    full_frequency: int = 20
