...
class DatamoduleArgsConfigCityscapes(NestedConfig):
    crop_size: List[int] = field(default_factory=lambda: [640, 360])
    base_size: List[int] = field(default_factory=lambda: [640, 360])
    base_size_val: List[int] = field(default_factory=lambda: [640, 360])
    ...
    data_dir: str = "~/Datasets/BDD100k_Anomaly"
    batch_size: int = 16
