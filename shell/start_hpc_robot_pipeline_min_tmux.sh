...
FWD_VGGT_TAPS_CAPTURE_DPT="${VGGT_TAPS_CAPTURE_DPT:-}"
...
FWD_VGGT_SEM_DINO_SCALE="${VGGT_SEM_DINO_SCALE:-}"
FWD_VGGT_SEM_TARGET_HW="${VGGT_SEM_TARGET_HW:-}"
FWD_VGGT_SEM_STRIDE_MODE="${VGGT_SEM_STRIDE_MODE:-}"
...
FWD_VGGT_RUNTIME_METRICS="${VGGT_RUNTIME_METRICS:-}"
FWD_VGGT_RUNTIME_METRICS_PATH="${VGGT_RUNTIME_METRICS_PATH:-}"
FWD_VGGT_WINDOW_SIZE="${VGGT_WINDOW_SIZE:-}"
FWD_VGGT_OVERLAP_SIZE="${VGGT_OVERLAP_SIZE:-}"
FWD_VGGT_TARGET_FPS="${VGGT_TARGET_FPS:-}"
FWD_VGGT_VIS_MAP="${VGGT_VIS_MAP:-}"
FWD_VGGT_VISER_PORT="${VGGT_VISER_PORT:-}"
...
FWD_VGGT_MODEL_AUTOCAST="${VGGT_MODEL_AUTOCAST:-}"
FWD_VGGT_LIVE_TEMP_IMAGE_FORMAT="${VGGT_LIVE_TEMP_IMAGE_FORMAT:-}"
FWD_VGGT_LIVE_TEMP_JPEG_QUALITY="${VGGT_LIVE_TEMP_JPEG_QUALITY:-}"
FWD_VGGT_LIVE_TEMP_PNG_COMPRESSION="${VGGT_LIVE_TEMP_PNG_COMPRESSION:-}"
FWD_VGGT_INPUT_MODE="${VGGT_INPUT_MODE:-}"
FWD_VGGT_OFFLINE_IMAGE_FOLDER="${VGGT_OFFLINE_IMAGE_FOLDER:-}"
FWD_VGGT_OFFLINE_USE_FLOW_FILTER="${VGGT_OFFLINE_USE_FLOW_FILTER:-}"
FWD_VGGT_SEM_INJECT_CHUNK_DIR="${VGGT_SEM_INJECT_CHUNK_DIR:-}"
...
${GPU_ALLOC_PREFIX} bash -lc '
  ...
  export VGGT_TAPS_CAPTURE_DPT="${FWD_VGGT_TAPS_CAPTURE_DPT}"
  ...
  export VGGT_SEM_DINO_SCALE="${FWD_VGGT_SEM_DINO_SCALE}"
  export VGGT_SEM_TARGET_HW="${FWD_VGGT_SEM_TARGET_HW}"
  export VGGT_SEM_STRIDE_MODE="${FWD_VGGT_SEM_STRIDE_MODE}"
  ...
  export VGGT_RUNTIME_METRICS="${FWD_VGGT_RUNTIME_METRICS}"
  export VGGT_RUNTIME_METRICS_PATH="${FWD_VGGT_RUNTIME_METRICS_PATH}"
  ...
  export VGGT_VIS_MAP="${FWD_VGGT_VIS_MAP}"
  export VGGT_VISER_PORT="${FWD_VGGT_VISER_PORT}"
  ...
  export VGGT_MODEL_AUTOCAST="${FWD_VGGT_MODEL_AUTOCAST}"
  ...
  export VGGT_INPUT_MODE="${FWD_VGGT_INPUT_MODE}"
  export VGGT_OFFLINE_IMAGE_FOLDER="${FWD_VGGT_OFFLINE_IMAGE_FOLDER}"
  export VGGT_OFFLINE_USE_FLOW_FILTER="${FWD_VGGT_OFFLINE_USE_FLOW_FILTER}"
  export VGGT_SEM_INJECT_CHUNK_DIR="${FWD_VGGT_SEM_INJECT_CHUNK_DIR}"
  export VGGT_SEM_INJECT_CHUNK_FORMAT="${FWD_VGGT_SEM_INJECT_CHUNK_FORMAT}"
  export VGGT_SEM_INJECT_START_INDEX="${FWD_VGGT_SEM_INJECT_START_INDEX}"
  export VGGT_SEM_INJECT_CHUNK_INDEX="${FWD_VGGT_SEM_INJECT_CHUNK_INDEX}"
