...
@dataclass
class DatamoduleArgsConfigBDDA(NestedConfig):
    val_batch_size: int = 1
    crop_size: List[int] = field(default_factory=lambda: None)
...
class DatamoduleConfig(NestedConfig):
    ...
    args: DatamoduleArgsConfigBDDA = field(
        default_factory=lambda: DatamoduleArgsConfigBDDA()
    )
