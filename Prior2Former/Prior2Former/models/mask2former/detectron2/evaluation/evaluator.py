...
from models.mask2former.detectron2.utils.comm import (
    get_world_size,
    is_main_process,
)
from models.mask2former.detectron2.utils.logger import (
    log_every_n_seconds,
)
...
def inference_on_dataset(
    ...
    Also Open_World_Benchmark the inference speed of `model.__call__` accurately.
    ...
    Args:
        ...
        evaluator: the evaluator(s) to run. Use `None` if you only want to Open_World_Benchmark,
